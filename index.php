...
<head>
	...
	<script id='script_viewport' type='text/javascript'>
		window.ladi_viewport=function(){var e=window.outerWidth>0?window.outerWidth:window.screen.width,i=e,t=e>=768,d="";void 0!==window.ladi_is_desktop&&null!=window.ladi_is_desktop||(window.ladi_is_desktop=t),d="width="+(i=t?960:420)+", user-scalable=yes";var w=1;!t&&i!=window.screen.width&&window.screen.width>0&&(w=window.screen.width/i),1!=w&&(d+=", initial-scale="+w+", minimum-scale="+w+", maximum-scale=4");var n=document.getElementById("viewport");n||((n=document.createElement("meta")).setAttribute("id","viewport"),n.setAttribute("name","viewport"),document.head.appendChild(n)),n.setAttribute("content",d)},window.ladi_viewport();
	</script>
